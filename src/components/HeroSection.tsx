        ...
        <div className="max-w-4xl mx-auto animate-fade-in-up">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-12 max-w-3xl mx-auto">
            {infoCards.map((card, index) => (
              <div 
                key={index}
                className="bg-card/30 backdrop-blur-sm border border-white/10 rounded-lg p-4 hover:bg-card/50 transition-all duration-300"
              >
                <div className="flex flex-col items-center text-center">
                  <div className="bg-neon-blue/20 p-2 rounded-lg mb-2">
                    <card.icon className="h-5 w-5 text-neon-blue" />
                  </div>
          ...
          <div className="mt-16 text-center">
            <p className="text-sm text-gray-500">
              Developed by{' '}
              <span className="text-neon-blue font-medium">Pavan Kumar Mallidi</span>
            </p>
          </div>
        </div>
      </div>
